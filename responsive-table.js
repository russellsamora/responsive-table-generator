(function() {
	...
	function createTable() {
		...
		var $source = $('<div contenteditable="true" class="responsive-graphic-source"><span class="pre-colon">' + _copy.sourcePre + '</span>: <span class="post-colon">' + _copy.sourcePost + '</span></div>');
